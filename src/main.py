        ...
        while True:
            ...
            try:
                ...
                boxes, logits, phrases = predict(
                    model=model,
                    image=image_tensor,
                    caption="a person holding a knife, fallen person, a fleeing person, a person holding a fork, a person holding a gun, a person holding an axe, a person holding a sickle, a person holding a glass bottle, a person holding a stone, a person holding a stick, a person holding a tool",
                    box_threshold=0.3,
                    text_threshold=0.25
                )
                ...
                if not alert_sent and detections_queue.count(True) == 8:
